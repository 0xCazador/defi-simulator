            ...
            >
                ...
                {langs.length === 0 ? (
                    <Center>
                        <Text mt={15} mb={15}>
                            <Trans>
                                There are no languages available that match the search query. Reset the search query to select a language.
                            </Trans>
                        </Text>
                    </Center>
                ) : (
                    <Text mb={8}>
                        {t`Select ${langs.length === 1 ? 'the' : 'one of the'} (${langs.length}) ${langs.length === 1 ? 'language' : 'languages'
